...
class Student extends Model
{
    ...
    public static function makeNewPayment($request , $id)
    {
        self::$payment = new Payment();
        self::$payment->student_id = $id;
        self::$payment->payment_fee = $request->payment_fee;
        self::$payment->payment_method = $request->payment_method;
